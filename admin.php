			...
			<div class="col-sm-12">
				<div class="main-content">
					...
					<div class="header">
		                ...
		                <h3 style="text-align: center;color:gray;"><strong>Admin</strong></h3>
		            </div>
					...
					<div class="l-part">
						<form action="" method="post">
		                    ...
		                    <a style="text-decoration:none;margin-left: 80%;color: #187FAB; font-weight:bold;font-size:16px;" href="user.php">Login as User</a>
