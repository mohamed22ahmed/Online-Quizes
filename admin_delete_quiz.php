<?php session_start();
include("admin_delete_quiz_test.php"); ?>
<!DOCTYPE html>
<html>
	<head>
		<title>Admin</title>
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="main-content">
					...
					<div class="header">
		                <h3 style="text-align: center;color:gray;"><strong>Delete Quiz</strong></h3>
		            </div>
					...
					<div class="l-part">
						<form action="" method="post">
							<input type="text" name="chapter" placeholder="Quiz Name" required class="form-control input-md" autocomplete="off"><br>
                            <input type="text" name="class" placeholder="Class" required class="form-control input-md" autocomplete="off"><br>
                            <center><button id="signin" class="btn btn-info btn-lg" name="delete">Delete</button></center>
