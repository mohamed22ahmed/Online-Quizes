		...
		<div class="row">
			<div class="col-sm-12">
				<div class="main-content">
					...
					<div class="header">
						<h3 style="text-align: center;"><strong>Delete Student</strong></h3>
		            </div>
                    <!-- end definition of page -->

                    <!-- enter the email of user you want to delete him -->
					<div class="l-part">
						<form action="" method="post">
                            <input type="email" name="email" placeholder="Email" required class="form-control input-md" autocomplete="off"><br>
                            <center><button id="signin" class="btn btn-info btn-lg" name="add">Delete</button></center>
